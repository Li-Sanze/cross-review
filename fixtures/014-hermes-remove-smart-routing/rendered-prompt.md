...
refactor: remove smart_model_routing feature
...
**Changed Files**:
- agent/smart_model_routing.py (python)
- cli-config.yaml.example
- cli.py (python)
- cron/scheduler.py (python)
- gateway/run.py (python)
- hermes_cli/config.py (python)
- hermes_cli/dump.py (python)
- hermes_cli/tips.py (python)
- hermes_cli/web_server.py (python)
- skills/autonomous-ai-agents/hermes-agent/SKILL.md (markdown)
- tests/agent/test_credential_pool_routing.py (python)
- tests/agent/test_smart_model_routing.py (python)
- tests/cli/test_cli_provider_resolution.py (python)
- tests/cli/test_fast_command.py (python)
- tests/cron/test_codex_execution_paths.py (python)
- tests/gateway/test_discord_channel_prompts.py (python)
- tests/gateway/test_fast_command.py (python)
- website/docs/integrations/providers.md (markdown)
...
index 6bb422ae..8e4ef342 100644
...
index 0e5e9ff6..3b1ecd8a 100644
--- a/cli.py
+++ b/cli.py
...
index 6e93fc02..ebeb29dd 100644
--- a/cron/scheduler.py
+++ b/cron/scheduler.py
...
index 60c57495..3b3ee38f 100644
--- a/gateway/run.py
+++ b/gateway/run.py
...
index 9040eac0..147194b6 100644
...
index f3a174e7..90364a26 100644
...
index aa6cb972..77c2b240 100644
...
index 2c42bfd9..50f6ff67 100644
...
index 362841f3..d19471c8 100644
...
index 38f5c6df..8477fdb6 100644
...
index fe4153c8..0c9aab82 100644
...
index bc6c8e5f..23a1a4aa 100644
...
index 354c95dd..65526f4a 100644
...
index 9c475bde..e1efd734 100644
...
index dc869ea1..82cc4fc6 100644
...
index 9d32fc21..013c6a3e 100644
